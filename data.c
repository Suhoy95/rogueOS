/* copied from gnu-efi for education purpose by following https://wiki.osdev.org/UEFI_Bare_Bones */
/*++
...
EFI_UNICODE_COLLATION_INTERFACE   LibStubUnicodeInterface = {
    ...
    // LibStubStrLwrUpr,
    // LibStubStrLwrUpr,
    NULL, NULL, NULL, NULL, // To avoid bloat and unnecessary dependencies on the rest of gnu-efi
